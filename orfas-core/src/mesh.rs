...
impl Mesh {
    ...
    /// Used in early version for debuging et to speed the dev
    /// Define the mesh by giving the numbers of nodes in each dimensions and the distance bewteen them in each dimension
